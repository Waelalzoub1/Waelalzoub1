...
**[mini-os32](https://github.com/Waelalzoub1/mini-os32)** — A 32-bit x86 operating system in C: BIOS and UEFI boot, kernel with paging, syscalls, NVMe driver, filesystem, framebuffer console, shell, and an in-OS C compiler that is self-hosting: the self-built compiler recompiles its own source inside the OS and reproduces itself byte for byte.
